...
class _SignUpPageState extends State<SignUpPage> {
  ...
  final List<_PasswordRequirement> _requirements = [
    ...
    _PasswordRequirement('At least one uppercase letter', (s) => s.contains(RegExp(r'[A-Z]'))),
    _PasswordRequirement('At least one lowercase letter', (s) => s.contains(RegExp(r'[a-z]'))),
    _PasswordRequirement('At least one number', (s) => s.contains(RegExp(r'[0-9]'))),
    _PasswordRequirement('At least one special character (@#\$%\^&\*! etc)', (s) => s.contains(RegExp(r'[@#\$%\^&\*!]'))),
  ];
                ...
                child: Padding(
                  ...
                  child: Glass3DCard(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.person_add_alt_1, size: 64, color: AppColors.primary),
...
class _PasswordRequirementsDialog extends StatefulWidget {
  ...
  const _PasswordRequirementsDialog({required this.requirements, required this.initialPassword});

  @override
  State<_PasswordRequirementsDialog> createState() => _PasswordRequirementsDialogState();
}

class _PasswordRequirementsDialogState extends State<_PasswordRequirementsDialog> {
